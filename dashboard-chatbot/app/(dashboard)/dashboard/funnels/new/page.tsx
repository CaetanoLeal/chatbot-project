...
export default function NewFunnelPage() {
  ...
  const id_funil = crypto.randomUUID(); // Gera um UUID para o novo funil
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Faz o POST para criar o registro do funil no seu backend
      ...
      if (!response.ok) {
        throw new Error("Erro ao criar o funil");
      }

      const data = await response.json();
      
      // Assim que o funil for criado, redireciona para a página de edição 
      // onde o FunnelFlowBuilder será renderizado com o ID correto
