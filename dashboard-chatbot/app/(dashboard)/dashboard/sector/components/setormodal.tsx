...
export default function SetorModal({
  ...
  */
  ...
  async function removerHorario(index: number) {
    ...
    if (
      !confirm("Deseja remover este horário?")
    ) {
      return;
    }
    ...
    try {
      ...
      if (horario.id_setor_horario) {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            erro.error || "Erro ao excluir horário."
          );
  ...
  */
    ...
    valor:string
      ...
      setHorarios(prev=>{
          ...
          if(
              ...
              alert(
                  "Já existe um horário neste intervalo."
              );
  ...
  function existeConflito(
      ...
      return horarios.some(h => {
          ...
          if (
              h.nu_dia_semana !==
              horarioAtual.nu_dia_semana
          )
              return false;

          return (
              h.hr_inicial < hrFinal &&
              h.hr_final > hrInicial
          );
  ...
  */
  ...
  async function removerDia(
      ...
      if (
          !confirm("Remover todos os horários deste dia?")
      ) {
          return;
      }

      const horariosDia = horarios.filter(
          h => h.nu_dia_semana === dia
      );
