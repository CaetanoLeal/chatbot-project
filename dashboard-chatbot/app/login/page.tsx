...
const leftNodes: NodeItem[] = [
  {
    ...
    label: "Usuário",
    sublabel: "Identidade",
    description: "Gerenciamento de perfil e credenciais de acesso do operador.",
    x: 120,
    y: 160,
    floatDelay: "0s",
  },
  {
    ...
    Icon: Lock,
    label: "Senha",
    sublabel: "Criptografia",
    description: "Proteção de dados com criptografia hash de ponta a ponta.",
    x: 80,
    y: CENTER_Y,
    floatDelay: "1.2s",
  },
  {
    ...
    Icon: ShieldCheck,
    label: "Verificação",
    sublabel: "Autenticação",
    description: "Camada de segurança e validação de sessão ativa.",
    x: 120,
    y: 520,
    floatDelay: "0.6s",
  },
...
const rightNodes: NodeItem[] = [
  ...
  },
  {
    ...
    description: "Central de disparos e histórico de conversas integradas.",
    x: 1120,
    y: CENTER_Y,
    floatDelay: "1.8s",
  },
  {
    ...
    label: "Bots & IA",
    sublabel: "Automação",
    description: "Assistentes virtuais inteligentes e respostas automáticas.",
    x: 1080,
    y: 520,
    floatDelay: "1.0s",
  },
