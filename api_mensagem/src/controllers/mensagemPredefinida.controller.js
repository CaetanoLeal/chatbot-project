...
async function get(req, res) {
  try {
    ...
    const mensagem =
      await mensagemPredefinidaService.buscarMensagemPredefinida(
...
async function update(req, res) {
  try {
    ...
    const mensagem =
      await mensagemPredefinidaService.atualizarMensagemPredefinida(
        id_mensagem_predefinida,
        {
          no_mensagem_predefinida,
          ds_mensagem_predefinida,
...
async function remove(req, res) {
  try {
    ...
    await mensagemPredefinidaService.excluirMensagemPredefinida(
      id_mensagem_predefinida
    )
